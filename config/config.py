...
flags.DEFINE_string('dataset_dir', '/home/zhangyuekun/dataset/NOCS', 'path to the dataset')
flags.DEFINE_string('detection_dir', '/home/zhangyuekun/dataset/NOCS/detection_dualposenet/data/segmentation_results', 'path to detection results')
...
flags.DEFINE_string('resume_model', '/home/zhangyuekun/my_Vote/GPV_Pose-master/output/modelsave_all/gpv_pose_update_my.pth', 'path to the saved model')
