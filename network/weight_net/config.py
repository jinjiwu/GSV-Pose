...
_C.snapshot_dir = "/home/zhangyuekun/GPV_Pose/network/weight_net/weights/geotransformer-modelnet.pth.tar"
...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(_C.root_dir, "network", "weight_net","data")
# _C.data.num_points = 717
_C.data.num_points = 1028
_C.data.voxel_size = None
_C.data.rotation_magnitude = 45.0
_C.data.translation_magnitude = 0.5
_C.data.keep_ratio = None
_C.data.crop_method = "plane"
_C.data.asymmetric = False
_C.data.twice_sample = False
_C.data.twice_transform = False
_C.data.have_template = True
_C.data.template_len = 1028
_C.data.scale_trans = 1.0
...
_C.fine_matching.confidence_threshold = 0.1
