...
from geotransformer.datasets.registration.NOCS.dataset import NOCSPairDataset
...
def test_data_loader(cfg):
    ...
    train_dataset = NOCSPairDataset(
        ...
        return_normals=False,
        return_occupancy=True,
        have_template = cfg.data.have_template,
        template_len = cfg.data.template_len,
        scale_trans = cfg.data.scale_trans
    )
    neighbor_limits = calibrate_neighbors_stack_mode(
        train_dataset,
        registration_collate_fn_stack_mode,
